...
class DiffusionModel(keras.Model):
    def __init__(
        ...
        for _ in range(2):
            ...
            x, temp, x_temp = SpatialTransformer(8, 40, fully_connected=False)(
                [x, context]
            )
        ...
        for _ in range(2):
            ...
            x, temp, x_temp = SpatialTransformer(8, 80, fully_connected=False)(
                [x, context]
            )
        ...
        for _ in range(2):
            ...
            x, temp, x_temp = SpatialTransformer(8, 160, fully_connected=False)(
                [x, context]
            )
        ...
        x = ResBlock(1280)([x, t_emb])
        x, weight_8, x_weights_8 = SpatialTransformer(8, 160, fully_connected=False)(
            [x, context]
        )
        x = ResBlock(1280)([x, t_emb])
